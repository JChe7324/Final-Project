...
def main():
	...
	map_points = {
        'map1': [
            (100, 150), (250, 200), (400, 180), (550, 250), (700, 300), (200, 500), (800, 800)
        ],
        'map2': [
            (50, 50), (180, 100), (300, 150), (450, 120), (550, 300)
        ],
        'map3': [
					...
					if start_pos.distance_to(end_pos) <= move_distance:
						...
						if not event_triggered_for_point:
							...
							if event_type == "bandit_attack":
								...
								enemy = Enemy(character.x_pos + 200 * (-1 if character.facing_right else 1), character.y_pos - 100)
								enemy_group.add(enemy)
								event_message += "Bandit Attack!!!!"
